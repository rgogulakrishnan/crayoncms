...
class RoleGroupController {
    ...
    def show(RoleGroup roleGroup) {
        ...
        def allRoles = Role.list().with { it.groupBy({ authority -> authority.groupName})}
        def authoritiesGrouped =  roleGroup.authorities.groupBy ({ authority -> authority.groupName })
